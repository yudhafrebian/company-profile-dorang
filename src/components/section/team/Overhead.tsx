...
const OverheadSection = () => {
  const [team, setTeam] = useState<OverheadMember[]>([]);
  ...
  return (
    <section className="p-5 pt-20 md:p-20 bg-[#F9FAFB]">
      <div className="max-w-6xl mx-auto text-center">
        <div className="flex flex-col items-center gap-4">
          <h2 className="text-xl md:text-3xl font-extrabold">Overhead Team</h2>
          <p className="md:w-1/2 text-sm md:text-base text-center mb-8">
            Leading the company with decades of expertise in food manufacturing
            and innovation.
          </p>
        </div>
